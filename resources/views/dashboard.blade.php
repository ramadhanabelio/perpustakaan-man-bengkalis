...
@section('content')
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pb-4">
            <div>
                <h3 class="fw-bold mb-3">Dashboard, Selamat datang di Perpustakaan MAN 1 Bengkalis</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card card-round">
                    <div class="card-header">
                        <div class="card-head-row">
                            <div class="card-title">Distribusi Buku</div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="chart-container" style="min-height: 275px">
    ...
    <script>
        ...
        new Chart(document.getElementById('bookChart'), {
            type: 'pie',
            data: {
                labels: {!! json_encode(array_keys($bookStatus)) !!},
                datasets: [{
                    data: {!! json_encode(array_values($bookStatus)) !!}
                }]
            }
        });
